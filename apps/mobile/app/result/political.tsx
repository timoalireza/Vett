...
function PoliticalOverview() {
  ...
  return (
    <View style={{ padding: theme.spacing(3), gap: theme.spacing(1.5) }}>
      <Text style={{ color: theme.colors.text, fontFamily: "Inter_700Bold" }}>Consensus summary</Text>
...
function BiasStats() {
  ...
  return (
    <View style={{ padding: theme.spacing(3), gap: theme.spacing(1) }}>
      <Text style={{ color: theme.colors.text, fontFamily: "Inter_700Bold" }}>Community</Text>
