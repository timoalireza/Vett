...
interface AnalysisCardHorizontalProps {
  id: string;
  title: string;
  score: number;
  topic?: string;
...
/**
 * Horizontal glass card for analysis display
 * Optimized for readability with larger title and smaller score
 */
export function AnalysisCardHorizontal({
  id,
  title,
  score,
  topic,
            ...
            <Text
              style={[
                styles.title,
                {
                  ...
                  fontWeight: "700",
                  letterSpacing: -0.3,
                  lineHeight: theme.typography.subheading * theme.typography.lineHeight.normal
                }
              ]}
              numberOfLines={2}
            >
